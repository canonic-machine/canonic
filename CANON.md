...
Each scope **SHOULD** document its lifecycle.

Lifecycle documentation **MUST** include:

- **Origin**: How the scope was discovered or created
- **Current state**: Human-driven, AI-assisted, or AI-automated
- **Automation drift**: The trajectory from manual to automated operation

This documents the evolution of each scope while preserving human authority over governance.
